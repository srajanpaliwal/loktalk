...
public interface ISql {
	...
	String INSERT_MSG = "INSERT OR REPLACE INTO Messages(ID, AppID, Content, Time, Nick) values (%d, %d, '%s', '%s', '%s')";
	String GET_MSG = "SELECT ID,AppID,Content,Time,Nick FROM Messages";
